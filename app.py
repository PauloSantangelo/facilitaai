    ...
    if request.method == 'POST':
        ...
        if file:
            ...
            if file.filename.lower().endswith(('.png', '.jpg', '.jpeg')):
                ...
                return render_template('results.html', caption=caption, media_url=filename, media_type='image')
                ...
                return render_template('results.html', caption=caption, media_url=filename, media_type='video')
            else:
...
def generate_caption_video(video_path, profile_description):
    ...
    cap.release()
    return generate_caption_image(frame_path, profile_description)
